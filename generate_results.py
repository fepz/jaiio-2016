...
def get_periods(path=None, fu=None):
    c_files = glob.glob("{0}/rtts_u*_n7_*.cpp".format("C:/Users/fep/Documents/src/cayssials2016/n7/total/c_files"))
...
def get_mbedata():
    ...
    paths = [("n7", path_7)]  # , ("n7", path_7), ("n10", path_10)]
...
def main():
    ...
    rts = data2[(data2["rts"] == 3) & (data2["fu"] == 90) & (data2["task"] == 6) & (data2["variable"] == "e")]
    period = rts.iloc[0]["t"]
